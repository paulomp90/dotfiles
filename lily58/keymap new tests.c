...
#define CTL_A LCTL_T(KC_S)
#define ALT_S LALT_T(KC_D)
#define GUI_F LGUI_T(KC_F)

// Right-hand home row mods
#define GUI_J RGUI_T(KC_J)
#define ALT_L LALT_T(KC_K)
#define CTL_SCLN RCTL_T(KC_L)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
    * |LSFT  |   A  |CTL_S |ALT_D |GUI_F |   G  |-------.    ,-------|   H  |GUI_J |ALT_K |CTL_L |   Ç  | BACK |
    * |------+------+------+------+------+------| GAME  |    |       |------+------+------+------+------+------|
    ...
    * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
    * | ctab |   A  |CTL_S |ALT_D |GUI_F |   G  |                    |   H  |GUI_J |ALT_K |CTL_L |   Ç  | B_DEL|
    * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
    ...
    * NEW NAV
    * ,-----------------------------------------.                    ,-----------------------------------------.
    * |      | WH UP|      | MUP  |      |      |                    | ms 2 | ms 1 | Home | End  | PGUP |      |
    * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
    * |      | WH DN|  <-M | MDN  | M->  |      |                    | Left | Down |  Up  |Right | PGDN |      |
    * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
    * |      |  WS  |      |      |      |      |-------.     ,------|msacc1|msacc2|      |      |      |      |
    * `-----------------------------------------/       /     \      \-----------------------------------------'
    *                          | LGUI |LOWER | /Space  /       \Enter \  |RAISE | RGUI |      
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        case KC_BSPC: {
            // if shifth is pressed, send a delete
